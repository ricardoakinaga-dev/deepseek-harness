...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/bundle/resilient-compaction': { kind: 'indirect', reason: 'The bundle delegates its model-request behavior to the compaction resilience policy it inserts.' },
